...
export const STARTING_R32_MATCHES: BracketMatch[] = [
  // Left Bracket
  { id: "R32_L1", homeId: "1A", awayId: "3rd1", matchTime: BRACKET_MATCH_TIMES["R32_L1"] },
  { id: "R32_L2", homeId: "2B", awayId: "2E", matchTime: BRACKET_MATCH_TIMES["R32_L2"] },
  { id: "R32_L3", homeId: "1C", awayId: "3rd2", matchTime: BRACKET_MATCH_TIMES["R32_L3"] },
  { id: "R32_L4", homeId: "1H", awayId: "2J", matchTime: BRACKET_MATCH_TIMES["R32_L4"] },
  { id: "R32_L5", homeId: "1D", awayId: "3rd3", matchTime: BRACKET_MATCH_TIMES["R32_L5"] },
  { id: "R32_L6", homeId: "2G", awayId: "2H", matchTime: BRACKET_MATCH_TIMES["R32_L6"] },
  { id: "R32_L7", homeId: "1E", awayId: "3rd4", matchTime: BRACKET_MATCH_TIMES["R32_L7"] },
  { id: "R32_L8", homeId: "1I", awayId: "2K", matchTime: BRACKET_MATCH_TIMES["R32_L8"] },
  // Right Bracket
  { id: "R32_R1", homeId: "1B", awayId: "3rd5", matchTime: BRACKET_MATCH_TIMES["R32_R1"] },
  { id: "R32_R2", homeId: "2A", awayId: "2F", matchTime: BRACKET_MATCH_TIMES["R32_R2"] },
  { id: "R32_R3", homeId: "1F", awayId: "3rd6", matchTime: BRACKET_MATCH_TIMES["R32_R3"] },
  { id: "R32_R4", homeId: "1J", awayId: "2L", matchTime: BRACKET_MATCH_TIMES["R32_R4"] },
  { id: "R32_R5", homeId: "1G", awayId: "3rd7", matchTime: BRACKET_MATCH_TIMES["R32_R5"] },
  { id: "R32_R6", homeId: "2C", awayId: "2D", matchTime: BRACKET_MATCH_TIMES["R32_R6"] },
  { id: "R32_R7", homeId: "1K", awayId: "3rd8", matchTime: BRACKET_MATCH_TIMES["R32_R7"] },
