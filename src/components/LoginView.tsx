    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gray-50 animate-in fade-in zoom-in-95 duration-500 overflow-y-auto pt-10 pb-10">
      <div className="bg-white p-6 sm:p-8 rounded-3xl shadow-sm border border-gray-100 max-w-md w-full text-center ring-1 ring-emerald-50 my-auto">
        ...
        <button 
          ...
          className="w-full flex justify-center items-center gap-3 bg-white border-2 border-gray-200 text-gray-700 font-bold py-3.5 px-4 rounded-xl hover:bg-gray-50 active:bg-gray-100 transition shadow-sm mb-6"
        >
        ...
        <form onSubmit={handleAuth} className="space-y-4 text-left">
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-300 text-white font-bold py-3 px-4 rounded-xl transition shadow-sm mt-2 flex justify-center items-center"
          >
            {loading ? (
